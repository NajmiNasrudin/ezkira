...
<body class="bg-gray-50 dark:bg-gray-950 text-gray-900 dark:text-gray-100 min-h-screen flex items-center justify-center font-sans">
    <div class="text-center px-6">
        <p class="text-7xl font-black text-brand-600 dark:text-brand-400 mb-2">404</p>
        <h1 class="text-2xl font-bold mb-2">Page Not Found</h1>
        <p class="text-gray-500 dark:text-gray-400 mb-8 max-w-sm">The page you are looking for does not exist or has been moved.</p>
