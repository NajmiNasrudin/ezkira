...
<head>
    ...
    <title>500 — <?= defined('APP_NAME') ? htmlspecialchars(APP_NAME) : 'SME Finance Monitor' ?></title>
...
<body class="bg-gray-50 dark:bg-gray-950 text-gray-900 dark:text-gray-100 min-h-screen flex items-center justify-center font-sans">
    <div class="text-center px-6">
        <p class="text-7xl font-black text-amber-500 mb-2">500</p>
        <h1 class="text-2xl font-bold mb-2">Server Error</h1>
        <p class="text-gray-500 dark:text-gray-400 mb-8 max-w-sm">Something went wrong on our end. Please try again later.</p>
