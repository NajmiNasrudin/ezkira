...
if (str_starts_with($page, '/revenue')) {
    ...
    $sections  = [
        ...
        [
            ...
            'body'  => $isMy
                ? '<p class="text-xs font-semibold text-gray-500 uppercase mb-1.5">📊 P&amp;L — Kos</p><ul class="space-y-1.5 mb-3"><li><b class="text-amber-600">COGS</b> — Kos barangan dijual (bahan mentah, stok)</li><li><b class="text-blue-600">OPEX</b> — Kos operasi (sewa, gaji, utiliti)</li><li><b class="text-purple-600">Marketing</b> — Iklan &amp; promosi</li><li><b class="text-cyan-600">Inventori</b> — Kos pembelian stok (direkod sebagai kos)</li></ul><p class="text-xs font-semibold text-gray-500 uppercase mb-1.5">🏢 Lembaran Imbangan</p><ul class="space-y-1.5"><li><b class="text-teal-600">PPE</b> — Aset tetap (mesin, kenderaan, peralatan)</li><li><b class="text-rose-600">Liabiliti</b> — Bayaran balik pinjaman / hutang</li></ul>'
                : '<p class="text-xs font-semibold text-gray-500 uppercase mb-1.5">📊 P&amp;L — Costs</p><ul class="space-y-1.5 mb-3"><li><b class="text-amber-600">COGS</b> — Cost of goods sold (materials, stock)</li><li><b class="text-blue-600">OPEX</b> — Operating costs (rent, salaries, utilities)</li><li><b class="text-purple-600">Marketing</b> — Advertising &amp; promotions</li><li><b class="text-cyan-600">Inventory</b> — Stock purchases (recorded as a cost)</li></ul><p class="text-xs font-semibold text-gray-500 uppercase mb-1.5">🏢 Balance Sheet</p><ul class="space-y-1.5"><li><b class="text-teal-600">PPE</b> — Fixed assets (machinery, vehicles, equipment)</li><li><b class="text-rose-600">Liability</b> — Loan / debt repayments</li></ul>',
        ],
        [
            'icon'  => '📊',
    ...
    $sections  = [
        ...
        [
            ...
            'body'  => $isMy
                ? '<p>Medan bertanda <span class="inline-block bg-emerald-100 text-emerald-700 text-xs font-semibold px-1.5 py-0.5 rounded">Auto</span> dikira secara automatik daripada rekod pendapatan, perbelanjaan, dan modal anda:</p><ul class="list-disc list-inside mt-2 space-y-1"><li><b>Tunai</b> = Modal + Pendapatan − Perbelanjaan</li><li><b>PPE</b> = Jumlah perbelanjaan kategori PPE</li><li><b>Inventori</b> = Jumlah perbelanjaan kategori Inventori</li><li><b>Modal Saham</b> = Jumlah modal yang direkod</li></ul>'
                : '<p>Fields marked <span class="inline-block bg-emerald-100 text-emerald-700 text-xs font-semibold px-1.5 py-0.5 rounded">Auto</span> are calculated automatically from your revenue, expense, and capital records:</p><ul class="list-disc list-inside mt-2 space-y-1"><li><b>Cash</b> = Capital + Revenue − Expenses</li><li><b>PPE</b> = Total PPE-category expenses</li><li><b>Inventory</b> = Total Inventory-category expenses</li><li><b>Share Capital</b> = Total recorded capital</li></ul>',
        ],
        [
            'icon'  => '💾',
