...
if (str_starts_with($page, '/revenue')) {
    ...
    $sections  = [
        ...
        [
            ...
            'body'  => $isMy
                ? '<ul class="space-y-2"><li><b class="text-amber-600">COGS</b> — Kos barangan yang dijual (bahan mentah, stok)</li><li><b class="text-blue-600">OPEX</b> — Kos operasi (sewa, gaji, utiliti)</li><li><b class="text-purple-600">Marketing</b> — Iklan &amp; promosi</li><li><b class="text-teal-600">PPE</b> — Aset tetap (mesin, peralatan)</li><li><b class="text-cyan-600">Inventori</b> — Pembelian stok / inventori</li><li><b class="text-rose-600">Liabiliti</b> — Bayaran balik pinjaman</li></ul>'
                : '<ul class="space-y-2"><li><b class="text-amber-600">COGS</b> — Cost of goods sold (raw materials, stock)</li><li><b class="text-blue-600">OPEX</b> — Operating costs (rent, salaries, utilities)</li><li><b class="text-purple-600">Marketing</b> — Advertising &amp; promotions</li><li><b class="text-teal-600">PPE</b> — Fixed assets (machinery, equipment)</li><li><b class="text-cyan-600">Inventory</b> — Stock / inventory purchases</li><li><b class="text-rose-600">Liability</b> — Loan repayments</li></ul>',
        ],
        [
            'icon'  => '📊',
